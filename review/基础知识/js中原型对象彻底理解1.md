...
<body>
    <script type="text/javascript">
		...
		*/
        ...
        //Person.prototype.constructor  Person函数的原型对象的构造函数又指向了Person函数
...
<script type="text/javascript">
    ...
    //此时Person.prototype.constructor指向native
...
<script type="text/javascript">
	...
	function Person(name, age) {
	    ...
	    this.age = age;
	    /*
	    	判断this.eat这个属性是不是function，如果不是function则证明是第一次创建对象，因为第一次创			建的时候，eat是undefined，
	    	则把这个funcion添加到原型中。
